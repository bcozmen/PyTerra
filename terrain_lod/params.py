...
erosion_params = {
    ...
    'talus': 0.01,
    'hydraulic_iterations': 5_000_000,
    'erosion_rate': 0.03,
    'deposition_rate': 0.01,
    'evaporation': 0.001,
    'slope_feedback_strength' : 0.15
}
...
mid_params = {
    ...
    'warp_y': 0.2,
    'ridge_strength': 0.0, # 0 = plain FBM hills, 1 = pure ridge noise
}
...
micro_params = {   
    ...
    'warp_x': 0.0,        # subtle domain warp on micro layer for natural variation
    'warp_y': 0.0,
    'ridge_strength': 0.0,   # some ridge character in micro layer for sharper rock detail
}
